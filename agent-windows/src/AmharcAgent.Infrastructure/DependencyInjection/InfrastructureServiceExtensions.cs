...
using AmharcAgent.Infrastructure.Security;
...
services.AddSingleton<IAgentSettingsStore>(sp =>
    new JsonAgentSettingsStore(
        ...
        services.AddSingleton<IProtectedCredentialStore, WindowsCredentialManagerStore>();
        ...
        // ???????????????????????????????????? Recording & Streaming ??????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????
        services.AddSingleton<FfmpegStreamReceiver>(sp =>
            new FfmpegStreamReceiver(
                sp.GetRequiredService<ICameraAdapter>(),
                sp.GetRequiredService<ILogger<FfmpegStreamReceiver>>(),
                settings.FfmpegPath));
        services.AddSingleton<IStreamReceiver>(sp =>
            sp.GetRequiredService<FfmpegStreamReceiver>());
        services.AddSingleton<IStreamReceiverMediaSource>(sp =>
            sp.GetRequiredService<FfmpegStreamReceiver>());
        ...
        services.AddSingleton<IRecordingAudioSourceResolver, AmharcAgent.Infrastructure.Audio.AxisRecordingAudioSourceResolver>();
